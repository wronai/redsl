...
```
redsl/
├── project        ├── vallm-pre-commit        ├── main        ├── main├── redsl/    ├── __main__    ├── consciousness_loop        ├── main        ├── pre-commit-hook        ├── cli_awareness        ├── _fixer_utils        ├── _scan_report        ├── doctor        ├── doctor_indent_fixers        ├── planfile_bridge        ├── main        ├── doctor_fstring_fixers        ├── main        ├── main        ├── doctor_helpers    ├── history        ├── doctor_data        ├── _guard_fixers        ├── doctor_fixers        ├── cli_doctor        ├── main        ├── hybrid        ├── cli_autonomy    ├── bad_code        ├── _indent_fixers        ├── batch            ├── verdict        ├── batch_pyqual/    ├── complex_code            ├── utils        ├── doctor_detectors            ├── reporting            ├── discovery            ├── helpers            ├── runner        ├── autofix/        ├── main            ├── todo_gen        ├── main            ├── config_gen            ├── reporting            ├── hybrid        ├── main            ├── discovery            ├── mypy_analyzer            ├── ruff_analyzer            ├── runner            ├── pipeline            ├── bandit_analyzer            ├── fix_decisions            ├── ast_analyzer            ├── reporter            ├── analyzer    ├── config        ├── pyqual/            ├── reporter            ├── git_ops        ├── basic_analysis    ├── examples/        ├── autonomy_pr/            ├── validator            ├── models        ├── _common        ├── custom_rules        ├── main        ├── api_integration    ├── diagnostics/            ├── models    ├── core/        ├── awareness        ├── full_pipeline        ├── pr_bot        ├── scan    ├── autonomy/        ├── badge        ├── perf_bridge        ├── intent        ├── audit        ├── review        ├── smart_scorer    ├── formatters/        ├── adaptive_executor        ├── core        ├── pipeline        ├── refactor        ├── debug        ├── multi_project        ├── quality_gate        ├── metrics        ├── pyqual    ├── cli/        ├── scan            ├── models        ├── __main__        ├── llm_banner        ├── batch        ├── cycle        ├── growth_control        ├── utils        ├── examples        ├── debug        ├── model_policy        ├── batch    ├── execution/        ├── sandbox_execution        ├── reporter        ├── resolution        ├── validation        ├── decision        ├── executor    ├── bridges/        ├── base        ├── reflector        ├── models    ├── llm/        ├── registry/        ├── gate        ├── refactor    ├── memory/            ├── sources/                ├── base        ├── direct_guard            ├── aggregator        ├── direct_types        ├── engine        ├── direct        ├── direct_imports        ├── prompts        ├── diff_manager    ├── refactors/            ├── pipeline        ├── body_restorer        ├── _base    ├── ci/        ├── direct_constants        ├── llx_router        ├── pyqual_example        ├── github_actions        ├── git_timeline        ├── auto_fix        ├── timeline_git        ├── proactive        ├── memory_learning        ├── change_patterns        ├── timeline_analysis        ├── self_model        ├── sandbox    ├── validation/        ├── vallm_bridge        ├── pyqual_bridge        ├── testql_bridge        ├── timeline_toon        ├── tool_check    ├── utils/    ├── awareness/        ├── json_helpers        ├── regix_bridge        ├── health_model        ├── analyzer        ├── incremental    ├── analyzers/        ├── metrics        ├── python_analyzer        ├── redup_bridge        ├── sumd_bridge            ├── models        ├── resolver        ├── utils        ├── toon_analyzer        ├── code2llm_bridge        ├── parsers/    ├── main            ├── functions_parser        ├── ecosystem            ├── validation_parser    ├── integrations/            ├── duplication_parser        ├── health_routes    ├── api/        ├── pyqual_routes        ├── webhook        ├── webhook_routes        ├── refactor_routes        ├── semantic_chunker            ├── project_parser        ├── debug_routes    ├── dsl/        ├── example_routes        ├── radon_analyzer        ├── rule_generator        ├── scheduler        ├── ast_transformers        ├── selection    ├── orchestrator        ├── models        ├── quality_visitor        ├── engine        ├── cycle        ├── timeline_models    ├── models        ├── models        ├── logging```
